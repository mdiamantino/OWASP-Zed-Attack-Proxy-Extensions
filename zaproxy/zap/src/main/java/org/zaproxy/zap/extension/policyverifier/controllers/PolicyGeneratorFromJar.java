...
public class PolicyGeneratorFromJar {
    ...
    public static Policy generatePolicy(File file) throws Exception {
        ...
        String policyName = file.getName().substring(0, file.getName().indexOf("."));     // Policy name without ".jar"
    ...
    /**
     * Method used to build a loader useful to convert classes of the jar in actual usable class in code
     *
     * @param jar Jar file
