...
public class JarPolicyGeneratorUnitTest {
    ...
    public void generatePolicy_JarContainsCorrect() {
        ...
        Policy policy = null;
        try {
            jarPolicyGenerator.setFile(jarForTest);
            policy = jarPolicyGenerator.generatePolicy();
        } catch (Exception e) {
            e.printStackTrace();
        }
        assert policy != null;
    ...
    public void generatePolicy_emptyFile_shouldThrowIllegalArgEx() throws IOException {
        ...
        jarPolicyGenerator.setFile(temp);
        assertThrows(IllegalArgumentException.class, () -> jarPolicyGenerator.generatePolicy());
        temp.deleteOnExit();
    }
    ...
    public void generatePolicy_nonRuleClassInJar_shouldThrowClassCastException() {
        ...
        jarPolicyGenerator.setFile(jarForTest);
        assertThrows(ClassCastException.class, () -> jarPolicyGenerator.generatePolicy());
    }
